...
<head>
	...
	<meta name="url" content="https://www.ammarindo.net/">
	<meta name="rating" content="General">
	<meta name="format-detection" content="telephone=no">

	<meta property="og:type" content="article" />
	<meta property="og:title" content="<?= $title ?>" />
	<meta property="og:description" content="A web application to monitor products' prices in Fabelio" />
	<meta property="og:image" content="<?=base_url('assets/img/logo.jpg'); ?>">

	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:site" content="@ekahandik">
	<meta name="twitter:creator" content="@ekahandik">
	<meta name="twitter:title" content="<?= $title ?>">
	<meta name="twitter:image" content="<?=base_url('assets/img/logo.jpg');?>">
	<meta name="twitter:description" content="A web application to monitor products' prices in Fabelio">
...
<body>
	<div uk-sticky="media: 960" class="uk-navbar-container uk-background-primary">
		<div class="uk-container uk-container-expand">
			<nav class="uk-navbar">
				<div class="uk-navbar-left"><a href="<?= base_url() ?>" class="uk-navbar-item uk-logo"> Fabelio Price Monitor
					</a></div>
